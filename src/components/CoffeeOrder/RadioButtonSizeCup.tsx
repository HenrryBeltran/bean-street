...
const radioButtonStyle = (
  ...
  return (
    <div className="flex h-16 items-center justify-between border border-brown-300 px-6 ui-checked:border-brown-700 ui-checked:bg-beige-200">
      <div className="flex items-center gap-x-6">
        <span className="text-brown-500 ui-checked:text-brown-700">
          {svgIcon}
        </span>
